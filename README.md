...
Functionality: **_Opens .csv file, creates java objects from contents_**
...
git clone https://github.com/jammazwan/xae_CsvFileToObjects.git
cd jammazwan.shared
mvn install 
```
...
so you can focus only on what is required to demo the **CsvFileToObjects** feature **_in isolation_**.
...
The prefix **xae** is used for maintaining sort order in a directory, providing packaging, and is otherwise meaningless. The x stands for _example_.
